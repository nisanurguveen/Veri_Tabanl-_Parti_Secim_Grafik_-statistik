...
namespace Veri_Tabanlı_Parti_Secim_Grafik_İstatistik
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-JH4F24U\SQLEXPRESS;Initial Catalog=DBSECİMPROJE;Integrated Security = True");
        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            //ilçe Adlarını Comboxa Çekme
            baglanti.Open();
